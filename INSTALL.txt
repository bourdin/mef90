...
### Configure petsc-3.3. 
  ...
  For instance, 
  MacBookGray:petsc-3.3-mef90 (mef90-3.3)$ ./configure --download-chaco=1 --download-exodusii=1 --download-hypre=1 --download-ml=1 --download-netcdf=1 --download-sowing=1 --download-yaml=1 --with-packages-download-dir=tarballs/ 
===============================================================================
...
The following packages need to be installed using homebrew:
  autoconf automake cmake gcc make
