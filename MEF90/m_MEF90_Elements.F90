...
#define __FUNCT__ "Element_P_Lagrange_3D_Scal_Init"
   Subroutine Element_P_Lagrange_3D_Scal_Init(dElem,dCoord,dPolynomialOrder,dQuadratureOrder,ierr)
      ...
      Case(7)
         ...
         Xi(11) = [ 0.1000000000000000_Kr, 0.2000000000000000_Kr, 0.1000000000000000_Kr ]
      ...
      Case(8)
         ...
         Xi(11) = [ 0.3162695526014501_Kr, 0.3162695526014501_Kr, 0.1837304473985499_Kr ]
         ...
         dElem%Gauss_C(10:15) =  0.0039485206398261_Kr / 6.0_Kr * detBinv
