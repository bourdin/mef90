          ...
          Do_iSLSig: Do iSLSig = 1, Elems_U(iE)%Nb_DoF
             ...
             Do_iSLEps: Do iSLEps = 1, Elems_U(iE)%Nb_DoF
                ...
                Do_iGUEps: Do iG = 1, Nb_Gauss
                   ...
                   ContrU(iG) = ContrU(iG) + ( Elems_U(iE)%Grad_BF(iSLEps,iG) .DotP. Elems_U(iE)%Grad_BF(iSLSig,iG) ) *            &
...
!!! Thermal stuff
          ...
          Do_iGE: Do iG = 1, Nb_Gauss
             MyEner = MyEner + Elems_U(iE)%Gauss_C(iG) * (ContrU(iG) * .5_Kr - ContrF(iG) - ContrTemp(iG))
          End Do Do_iGE
