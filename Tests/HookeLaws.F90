...
#include "finclude/petscdef.h"
   ...
   Write(*,100) E,nu
   Call MEF90_HookeLawIsoENu_3D(HookeLaw3D,E,nu)
   
   If (mef90) Then
      Write(*,*)"3D isotropic"
      Write(*,201) HookeLaw3D
      Call MEF90_HookeLawIsoEnu_2DPlaneStress(HookeLaw2D,E,nu)
      Write(*,*)"2D plane stress"
      Write(*,202) HookeLaw2D
      Call MEF90_HookeLawIsoEnu_2DPlaneStrain(HookeLaw2D,E,nu)
