...
#include <petsc/finclude/petsc.h>
    ...
    TestMass: Block
        ...
        PetscCallA(VecViewFromOptions(Uglob,PETSC_NULL_OPTIONS,"-mef90VecU0_view",ierr))
        PetscCallA(VecViewFromOptions(MUglob,PETSC_NULL_OPTIONS,"-mef90VecMU0_view",ierr))
