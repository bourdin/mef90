...
def exo2exo(fin,fout):
    ...
    fixedX = np.empty(nVertices,dtype=ctypes.c_double) #exo.c_double)
    fixedY = np.empty(nVertices,dtype=ctypes.c_double) #exo.c_double)
    fixedZ = np.empty(nVertices,dtype=ctypes.c_double) #exo.c_double)
