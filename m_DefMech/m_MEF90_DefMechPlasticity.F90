...
!!!  (c) 2022-23 Blaise Bourdin bourdin@mcmaster.ca
!!!

   Subroutine MEF90DefMechPlasticStrainUpdate(MEF90DefMechCtx,plasticStrain,x,PlasticStrainOld,plasticStrainPrevious,cumulatedPlasticDissipationDensityIncrement,cumulatedPlasticDissipationDensityOld,ierr)
      ...
      Type(tVec),Intent(IN)                              :: x,PlasticStrainOld,plasticStrainPrevious,cumulatedPlasticDissipationDensityIncrement,cumulatedPlasticDissipationDensityOld
      PetscErrorCode,Intent(INOUT)                       :: ierr

#ifdef MEF90_HAVE_SNLP
      Type(DM)                                           :: Mesh
      Type(SectionReal)                                  :: plasticStrainSec,plasticStrainOldSec,inelasticStrainSec,plasticStrainPreviousSec,cumulatedPlasticDissipationDensityIncrementSec,cumulatedPlasticDissipationDensitySec
      OldSec
      PetscReal,Dimension(:),Pointer                     :: plasticStrainLoc,plasticStrainOldLoc,inelasticStrainLoc,damageLoc,plasticStrainPreviousLoc
      PetscReal,Dimension(:),Pointer                     :: cumulatedDissipatedPlasticEnergyVariationLoc,cumulatedPlasticDissipationDensityOldLoc
      ...
      Call SectionRealDuplicate(MEF90DefMechCtx%cellDMScalSec,cumulatedPlasticDissipationDensityIncrementSec,ierr);CHKERRQ(ierr)
      Call SectionRealToVec(cumulatedPlasticDissipationDensityIncrementSec,MEF90DefMechCtx%cellDMScalScatter,SCATTER_REVERSE,cumulatedPlasticDissipationDensityIncrement,ierr);CHKERRQ(ierr)

      Call SectionRealDuplicate(MEF90DefMechCtx%cellDMScalSec,cumulatedPlasticDissipationDensitySec
      OldSec,ierr);CHKERRQ(ierr)
      Call SectionRealToVec(cumulatedPlasticDissipationDensitySec
      OldSec,MEF90DefMechCtx%cellDMScalScatter,SCATTER_REVERSE,cumulatedPlasticDissipationDensityOld,ierr);CHKERRQ(ierr)
   ...
   PlasticityCtx%isPlaneStress = .FALSE.
               ...
               Do cell = 1,size(cellID)
                  ...
                  Call SectionRealRestrict(cumulatedPlasticDissipationDensityIncrementSec,cellID(cell),cumulatedDissipatedPlasticEnergyVariationLoc,ierr);CHKERRQ(ierr)
                  Call SectionRealRestrict(cumulatedPlasticDissipationDensityOldSec,cellID(cell),cumulatedPlasticDissipationDensityOldLoc,ierr);CHKERRQ(ierr)
                  ...
                  PlasticityCtx%cumulatedDissipatedPlasticEnergy = cumulatedPlasticDissipationDensityOldLoc(1)
                  ...
                  Call SectionRealRestore(cumulatedPlasticDissipationDensityIncrementSec,cellID(cell),cumulatedDissipatedPlasticEnergyVariationLoc,ierr);CHKERRQ(ierr)
                  Call SectionRealRestore(cumulatedPlasticDissipationDensitySec
                  OldSec,cellID(cell),cumulatedPlasticDissipationDensityOldLoc,ierr);CHKERRQ(ierr)
      ...
      Call SectionRealToVec(cumulatedPlasticDissipationDensityIncrementSec,MEF90DefMechCtx%cellDMScalScatter,SCATTER_FORWARD,cumulatedPlasticDissipationDensityIncrement,ierr);CHKERRQ(ierr)
      ...
      Call SectionRealDestroy(cumulatedPlasticDissipationDensityIncrementSec,ierr);CHKERRQ(ierr)
      Call SectionRealDestroy(cumulatedPlasticDissipationDensitySec
      OldSec,ierr);CHKERRQ(ierr)
