...
#include "include/finclude/petsc.h"
  ...
  Interface Write_Rupt_EXO_Params
      Module Procedure Write_Rupt_EXO_Params_Iso, Write_Rupt_EXO_Params_Hooke2D
  End Interface

  Interface Read_Rupt_DATA
      Module Procedure Read_Rupt_DATA_Iso, Read_Rupt_DATA_Hooke2D
  End Interface
...
Contains
  ...
  Subroutine Read_Rupt_EXO_Params_Hooke2D(Geom, Params)
    Type (EXO_Geom_Info)                          :: Geom
    ...
    Do iTS = 1, Size(Params%Load)
       Call Read_EXO_Result_Global(Geom, 4, iTS, Params%Load(iTS))
    End Do
  End Subroutine Read_Rupt_EXO_Params_Hooke2D
  ...
  Subroutine Write_Rupt_EXO_Params_Iso(Geom, Params)
    ...
    Geom%QA_Rec(2,Geom%Num_QA) = '0.0.6'
  ...
  Subroutine Write_Rupt_EXO_Params_Hooke2D(Geom, Params)
    Type (EXO_Geom_Info)                          :: Geom
    Type (Rupt_Params_Hooke2D)                    :: Params
    ...
    Call EXCLOS(Geom%exoid, iErr)
    Geom%exoid = 0
  End Subroutine Write_Rupt_EXO_Params_Hooke2D
...
!    Write(F_OUT, 100) Params%PB_Type,      'PB_Type  [0=DISPL 1=THERM 2=ELAST]'
...
120 Format(I4, 4(ES12.5,' '))
  ...
  Subroutine Write_Rupt_DATA_Hooke2D(Geom, Params)
    Type (EXO_Geom_Info)                          :: Geom
    Type (Rupt_Params_Hooke2D)                    :: Params
...
120 Format(I4, 6(ES12.5,' '))
  ...
  Subroutine Read_Rupt_DATA_Hooke2D(Geom, Params)
    Type (EXO_Geom_Info)                          :: Geom
    Type (Rupt_Params_Hooke2D)                    :: Params
