...
!  Integer, Parameter, Public                      :: PB_DISPL = 0
!  Integer, Parameter, Public                      :: PB_THERM = 1
!  Integer, Parameter, Public                      :: PB_ELAST = 2
...
!  Integer, Parameter, Public                      :: PB_1D  = 0
!  Integer, Parameter, Public                      :: PB_2DA = 1
...
Contains
  ...
  Subroutine Read_Rupt_EXO_Params(Geom, Params)
    ...
    End Do
  End Subroutine Read_Rupt_EXO_Params

  Subroutine Write_Rupt_EXO_Params(Geom, Params)
    Type (EXO_Geom_Info)                          :: Geom
    Type (Rupt_Params)                            :: Params
    ...
    Call EXCLOS(Geom%exoid, iErr)
    Geom%exoid = 0
  End Subroutine Write_Rupt_EXO_Params
  
  Subroutine Write_Rupt_DATA(Geom, Params)
    Type (EXO_Geom_Info)                          :: Geom
    Type (Rupt_Params)                            :: Params
...
120 Format(I4, 4(ES12.5,' '))
  End Subroutine Write_Rupt_DATA
 
  Subroutine Read_Rupt_DATA(Geom, Params)
    Type (EXO_Geom_Info)                          :: Geom
    Type (Rupt_Params)                            :: Params
